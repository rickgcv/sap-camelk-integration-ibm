// camel-k: language=java open-api=ibm-sap.yaml dependency=camel-jacksonxml dependency=camel-openapi-java dependency=camel-jackson property-file=sap.properties
...
public class SapOdata extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    from("direct:fetchall")
      ...
      .setHeader("Authorization").constant("Basic czAwMTIwMTI1MTU6c2Fua2V0QDE=")
